          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="powierzeniaApp.knowledgeArea.course">Course</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="powierzeniaApp.knowledgeArea.teacher">Teacher</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {knowledgeAreaList.map((knowledgeArea, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{knowledgeArea.courseId ? <Link to={`course/${knowledgeArea.courseId}`}>{knowledgeArea.courseId}</Link> : ''}</td>
                  <td>{knowledgeArea.teacherId ? <Link to={`teacher/${knowledgeArea.teacherId}`}>{knowledgeArea.teacherId}</Link> : ''}</td>
