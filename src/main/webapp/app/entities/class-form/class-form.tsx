          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="powierzeniaApp.classForm.teacher">Teacher</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {classFormList.map((classForm, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{classForm.teacherId ? <Link to={`teacher/${classForm.teacherId}`}>{classForm.teacherId}</Link> : ''}</td>
