        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : classFormEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label for="class-form-teacher">
                  <Translate contentKey="powierzeniaApp.classForm.teacher">Teacher</Translate>
                </Label>
                <AvInput id="class-form-teacher" type="select" className="form-control" name="teacherId">
                  <option value="" key="0" />
                  {teachers
