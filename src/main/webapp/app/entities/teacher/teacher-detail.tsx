    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>{teacherEntity.entrustmentsId ? teacherEntity.entrustmentsId : ''}</dd>
          <dt>
            <Translate contentKey="powierzeniaApp.teacher.preferedCourses">Prefered Courses</Translate>
          </dt>
          <dd>{teacherEntity.preferedCoursesId ? teacherEntity.preferedCoursesId : ''}</dd>
          <dt>
            <Translate contentKey="powierzeniaApp.teacher.knowledgeAreas">Knowledge Areas</Translate>
          </dt>
          <dd>{teacherEntity.knowledgeAreasId ? teacherEntity.knowledgeAreasId : ''}</dd>
          <dt>
            <Translate contentKey="powierzeniaApp.teacher.allowedClassForms">Allowed Class Forms</Translate>
          </dt>
          <dd>{teacherEntity.allowedClassFormsId ? teacherEntity.allowedClassFormsId : ''}</dd>
        </dl>
