...
export const CourseClassUpdate = (props: ICourseClassUpdateProps) => {
  ...
  const { courseClassEntity, entrustments, loading, updating } = props;
        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : courseClassEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label for="course-class-entrustments">
                  <Translate contentKey="powierzeniaApp.courseClass.entrustments">Entrustments</Translate>
                </Label>
                <AvInput id="course-class-entrustments" type="select" className="form-control" name="entrustmentsId">
                  <option value="" key="0" />
                  {entrustments
