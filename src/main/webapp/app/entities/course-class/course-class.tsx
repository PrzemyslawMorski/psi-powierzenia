          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="powierzeniaApp.courseClass.entrustments">Entrustments</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {courseClassList.map((courseClass, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    {courseClass.entrustmentsId ? (
                      <Link to={`entrustment/${courseClass.entrustmentsId}`}>{courseClass.entrustmentsId}</Link>
                    ) : (
                      ''
                    )}
                  </td>
