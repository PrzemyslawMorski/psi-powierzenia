...
export const EducationPlanUpdate = (props: IEducationPlanUpdateProps) => {
  const [educationPlansId, setEducationPlansId] = useState('0');
  const [coursesId, setCoursesId] = useState('0');
  const [isNew, setIsNew] = useState(!props.match.params || !props.match.params.id);

  const { educationPlanEntity, entrustmentPlans, courses, loading, updating } = props;
        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : educationPlanEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="fieldOfStudyLabel" for="education-plan-fieldOfStudy">
                  <Translate contentKey="powierzeniaApp.educationPlan.fieldOfStudy">Field Of Study</Translate>
                </Label>
                <AvInput
                  id="education-plan-fieldOfStudy"
                  type="select"
                  className="form-control"
                  name="fieldOfStudy"
                  value={(!isNew && educationPlanEntity.fieldOfStudy) || 'INFORMATION_TECHNOLOGY'}
                >
                  <option value="INFORMATION_TECHNOLOGY">{translate('powierzeniaApp.FieldOfStudy.INFORMATION_TECHNOLOGY')}</option>
                  <option value="MANAGMENT">{translate('powierzeniaApp.FieldOfStudy.MANAGMENT')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup>
                <Label for="education-plan-educationPlans">
                  <Translate contentKey="powierzeniaApp.educationPlan.educationPlans">Education Plans</Translate>
                </Label>
                <AvInput id="education-plan-educationPlans" type="select" className="form-control" name="educationPlansId">
                  <option value="" key="0" />
                  {entrustmentPlans
              ...
              <AvGroup>
                <Label for="education-plan-courses">
                  <Translate contentKey="powierzeniaApp.educationPlan.courses">Courses</Translate>
                </Label>
                <AvInput id="education-plan-courses" type="select" className="form-control" name="coursesId">
                  <option value="" key="0" />
                  {courses
