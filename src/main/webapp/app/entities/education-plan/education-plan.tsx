          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="powierzeniaApp.educationPlan.courses">Courses</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {educationPlanList.map((educationPlan, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <Translate contentKey={`powierzeniaApp.FieldOfStudy.${educationPlan.fieldOfStudy}`} />
                  </td>
                  <td>
                  ...
                  <td>
                    {educationPlan.educationPlansId ? (
                      <Link to={`entrustment-plan/${educationPlan.educationPlansId}`}>{educationPlan.educationPlansId}</Link>
                    ) : (
                      ''
                    )}
                  </td>
                  <td>{educationPlan.coursesId ? <Link to={`course/${educationPlan.coursesId}`}>{educationPlan.coursesId}</Link> : ''}</td>
