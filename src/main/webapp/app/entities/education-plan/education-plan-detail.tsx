    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>{educationPlanEntity.fieldOfStudy}</dd>
          <dt>
          ...
          <dd>{educationPlanEntity.educationPlansId ? educationPlanEntity.educationPlansId : ''}</dd>
          <dt>
            <Translate contentKey="powierzeniaApp.educationPlan.courses">Courses</Translate>
          </dt>
          <dd>{educationPlanEntity.coursesId ? educationPlanEntity.coursesId : ''}</dd>
        </dl>
