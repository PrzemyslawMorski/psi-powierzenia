...
public class EducationPlanResourceIT {
    ...
    private static final FieldOfStudy DEFAULT_FIELD_OF_STUDY = FieldOfStudy.INFORMATION_TECHNOLOGY;
    private static final FieldOfStudy UPDATED_FIELD_OF_STUDY = FieldOfStudy.MANAGMENT;
    ...
    public void createEducationPlan() throws Exception {
        ...
        assertThat(testEducationPlan.getFieldOfStudy()).isEqualTo(DEFAULT_FIELD_OF_STUDY);
    ...
    public void updateEducationPlan() throws Exception {
        ...
        assertThat(testEducationPlan.getFieldOfStudy()).isEqualTo(UPDATED_FIELD_OF_STUDY);
