...
public class KnowledgeAreaResourceIT {
    ...
    private static final KnowledgeAreaType DEFAULT_TYPE = KnowledgeAreaType.DATABASES;
    private static final KnowledgeAreaType UPDATED_TYPE = KnowledgeAreaType.DESIGN;
