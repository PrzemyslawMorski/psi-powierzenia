...
describe('Teacher e2e test', () => {
  ...
  it('should create and save Teachers', async () => {
    async function createTeacher() {
      ...
      await teacherUpdatePage.entrustmentsSelectLastOption();
      await teacherUpdatePage.preferedCoursesSelectLastOption();
      await teacherUpdatePage.knowledgeAreasSelectLastOption();
      await teacherUpdatePage.allowedClassFormsSelectLastOption();
